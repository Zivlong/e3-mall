...
<form id="orderForm" class="hide" action="/order/create.html" method="post">
	...
	<input type="hidden" name="orderShipping.receiverName" value="zjl"/>
	<input type="hidden" name="orderShipping.receiverMobile" value="1333333333"/>
	<input type="hidden" name="orderShipping.receiverState" value="太原市"/>
	<input type="hidden" name="orderShipping.receiverCity" value="太原市"/>
	<input type="hidden" name="orderShipping.receiverDistrict" value="晋祠"/>
	<input type="hidden" name="orderShipping.receiverAddress" value="晋祠里面"/>
</form>
